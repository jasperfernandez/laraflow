 ...
 * @property-read Model|null $status
 * @property-read Collection<int, WorkflowInstanceStepAssignment> $assignments
 * @property-read Collection<int, WorkflowInstanceTransition> $outgoingTransitions
 * @property-read Collection<int, WorkflowInstanceTransition> $incomingTransitions
 */
